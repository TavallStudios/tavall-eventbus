...
Standalone Tavall Java module providing core infrastructure capabilities.

## Source of Truth & Development

- `TavallStudios/tavall-eventbus:main` is canonical for code, releases, tags, issues, and pull requests.
